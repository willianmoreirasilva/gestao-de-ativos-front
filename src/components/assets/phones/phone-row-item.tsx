...
import { Eye, Link2, Phone, PhoneCall } from "lucide-react";
...
export function PhoneRowItem({ asset }: PhoneRowItemProps) {
    ...
    const identifier = `${asset.phone?.model || "Telefone"} - Ramal ${phoneNumber}`;
    ...
    return (
        <TooltipProvider delayDuration={200}>
            <TableRow className="hover:bg-zinc-50/50 dark:hover:bg-zinc-900/30 transition-colors">
                {/* Ramal / Número (Destaque Intuitivo) */}
                <TableCell className="py-3.5 pl-5">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            <span className="font-bold text-zinc-900 dark:text-zinc-100 font-mono text-sm tracking-wide">
                                {phoneNumber}
                            </span>
                ...
                <TableCell className="py-3.5 font-medium text-xs text-zinc-700 dark:text-zinc-300">
                    <div className="flex items-center gap-1.5">
                        ...
                        {asset.phone?.model || "Modelo Genérico / VoIP"}
                    </div>
                </TableCell>
                ...
                {/* Alocação Operacional (Quem / Onde) */}
                <TableCell className="py-3.5 hidden sm:table-cell">
                    <div className="flex flex-col text-xs">

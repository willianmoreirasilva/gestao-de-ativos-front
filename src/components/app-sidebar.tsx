...
import { QuickSearchModal } from "./assets/quick-search-modal";
...
export function AppSidebar({ user }: AppSidebarProps) {
    ...
    // 🎹 Listener global para o atalho Ctrl+K / Cmd+K
    useEffect(() => {
    ...
    return (
        <>
                                        ...
                                        <SidebarGroup className="p-0">
                                            <SidebarGroupContent>
                                                <SidebarMenu>
                                                    {allowedItems.map(
                                                        (item) => {
                                                            // 🌟 TRATAMENTO PARA CONSULTA RÁPIDA (MODAL)
                                                            if (
                                                                item.isQuickSearch
                                                            ) {
                                                                return (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            <button
                                                                                ...
                                                                                className="flex items-center justify-between w-full px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 font-sans antialiased text-amber-500 hover:bg-amber-500/10 hover:text-amber-400 cursor-pointer"
                                                                            >
                                                            ...
                                                            // 🌟 ITENS CONVENCIONAIS (LINKS DE ROTA)
                                                            const isActive =
                                                                pathname ===
                                                                item.url;
                                                            return (
            ...
            {/* 🔍 MODAL DE CONSULTA RÁPIDA (COMMAND PALETTE) */}

...
export default async function EditComputerPage({ params }: PageProps) {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Editar Computador</h1>
        <p className="text-sm text-zinc-500">Modifique as configurações patrimoniais e técnicas do ativo.</p>
      </div>
